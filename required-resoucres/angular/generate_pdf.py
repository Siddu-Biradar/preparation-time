...
HTML_PATH = BASE_DIR / "angular-complete-interview-guide.html"
PDF_PATH = BASE_DIR / "angular-complete-interview-guide.pdf"
            ...
            if name == "h1":
                ...
                if "pill-row" in classes:
                    ...
                    for nested in child.children:
                        ...
                        if nested_name == "h4":
                            section_items.append(Paragraph(paragraph_markup(nested), styles["GuideH4"]))
                        elif nested_name in {"ul", "ol"}:
                            for li in nested.find_all("li", recursive=False):
                                section_items.append(Paragraph(f"• {paragraph_markup(li)}", styles["GuideBullet"]))
...
def main() -> None:
    doc = SimpleDocTemplate(
        ...
        topMargin=18 * mm,
        bottomMargin=16 * mm,
        title="Complete Angular Interview Preparation Guide",
